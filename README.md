...
- **インタラクティブなUI**:
    ...
    - **ボトムシートによるコントロールパネル**: 画面下部からスワイプアップすることで、設定用のコントロールパネルが表示されます。
...
- **UI**:
  ...
  - **インタラクション**: `BottomSheetScaffold` を利用して、インタラクティブな設定パネルを提供しています。
- **音声処理**:
...
- **技術仕様**
    - [サンリオピューロランドのミラクル♡ライトの仕組み。制御と解析。](https://titn-nanana.hatenablog.com/entry/2017/12/15/200000)

- **信号出力**
    - [ミラクル♡ライトコントローラ](https://storage.googleapis.com/jirox-hobby/trivial/miracle_heart_light/index.html)
